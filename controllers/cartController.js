  ...
  addToCart: async (req, res) => {
    try {
      ...
      if (idx > -1) {
        ...
        cart.items.push({ product: { id: product.id, name: product.name, price: parseFloat(product.price), imageUrl: product.imageUrl || product.image_url, store_id: product.store_id || null }, quantity });
      }
